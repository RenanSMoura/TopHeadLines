package dev.moura.test.challenge.ctw.data.source.network.api.di
...
import dev.moura.test.challenge.ctw.data.source.network.api.interceptors.AuthInterceptor
...
object ApiModule {
    ...
    fun providesHttpLoginInterceptor() = HttpLoggingInterceptor().apply {
        level = if (dev.moura.test.challenge.ctw.BuildConfig.DEBUG) {
